...
#pragma mark - 布局(适配竖屏)
//布局(适配竖屏)
-(void)tryLayoutSubViews_Portrait:(UIViewController *)authVC userInfo:(FVSDKHyProtocolUserInfo *)userInfo{
    //授权页view
    UIView * authPageView = authVC.view;
...
//😀自定义控件和授权页基本控件可以放一起统一布局
    ...
    float height = [FVDDemoHelper isPhoneX]?(115+36.0):115;
    ...
    [bottomView mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(- FVD_TabbarSafeBottomMargin - 10);
        make.centerX.mas_equalTo(0);
        make.width.mas_equalTo(FVD_ScreenWidth);
...
-(void)tryLayoutSubViews_Landscape:(UIViewController *)authVC userInfo:(FVSDKHyProtocolUserInfo *)userInfo{
    ...
    [phoneLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.mas_equalTo(0);
        make.height.mas_equalTo(30);
        make.width.mas_equalTo(FVD_ScreenHeight * 0.8);
    }];
    [sloganLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
...
+(void)setPrivacySettingExample:(FVSDKHyUIConfigure *)uiConfigure{
    ...
    uiConfigure.privacySettings = @[({
        FVSDKHyPrivacyText * text_des_0 = [FVSDKHyPrivacyText new];
        ...
        //运营商协议占位
        FVSDKHyPrivacyText * text_operator = [FVSDKHyPrivacyText new];
        ...
        FVSDKHyPrivacyText * text_des_1 = [FVSDKHyPrivacyText new];
        text_des_1.text = @"和";
        text_des_1.textColor = baseTextColor;
        text_des_1.textFont = commonFont;
        text_des_1;
    }),({
        FVSDKHyPrivacyText * text_myPrivacy0 = [FVSDKHyPrivacyText new];
        text_myPrivacy0.text = @"FlyVerify服务协议";
        text_myPrivacy0.textLinkString = @"https://policy.zztfly.com/sdk/verify/privacy";
        text_myPrivacy0.textColor =privacyTextColor;
        text_myPrivacy0.textFont = commonFont;
        text_myPrivacy0;
    }),({
        FVSDKHyPrivacyText * text_des_2 = [FVSDKHyPrivacyText new];
        text_des_2.text = @"、";
        text_des_2.textColor = baseTextColor;
        text_des_2.textFont = commonFont;
        text_des_2;
    }),({
        FVSDKHyPrivacyText * text_myPrivacy1 = [FVSDKHyPrivacyText new];
        ...
        FVSDKHyPrivacyText * text_des_3 = [FVSDKHyPrivacyText new];
