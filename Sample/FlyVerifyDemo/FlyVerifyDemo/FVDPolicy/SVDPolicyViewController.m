...
- (void)loadData {
    NSMutableAttributedString *attribute = [[NSMutableAttributedString alloc] initWithString:@"    欢迎您使用FlyVerify提供的演示DEMO，FlyVerify是一款帮助开发者实现一键验证功能的产品，从根源上降低企业验证成本，有效提高拉新转化率，降低因验证带来的流失率，3秒完成手机号验证。我们将依据FlyVerify的《隐私政策》来帮助你了解我们需要收集哪些数据。\n\n\n详情点击:" attributes:@{
