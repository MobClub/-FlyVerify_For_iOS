...
#define FV_ScreenWidth ([UIScreen mainScreen].bounds.size.width)
#define FV_ScreenHeight ([UIScreen mainScreen].bounds.size.height)
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext]
        ...
        {
            contentBgView.frame = CGRectMake(rawFrame.origin.x,
                                             self.isPresentAnimation ? rawFrame.origin.y : FV_ScreenHeight,
                                             rawFrame.size.width,
                                             rawFrame.size.height);
        }
